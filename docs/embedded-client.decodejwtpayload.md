...
[Home](./index.md) &gt; [@cerbos/embedded-client](./embedded-client.md) &gt; [DecodeJWTPayload](./embedded-client.decodejwtpayload.md)
...
```
**References:** [JWT](./core.jwt.md)<!-- -->, [Awaitable](./core.awaitable.md)<!-- -->, [DecodedJWTPayload](./embedded-client.decodedjwtpayload.md)
