...
export const ServerStop = {
  fromJSON(object: any): ServerStop {
    return {
      ...
      requestsTotal: isSet(object.requestsTotal) ? Number(object.requestsTotal) : 0,
    };
  },
  ...
  toJSON(message: ServerStop): unknown {
    ...
    message.requestsTotal !== undefined && (obj.requestsTotal = Math.round(message.requestsTotal));
    return obj;
  },
};
