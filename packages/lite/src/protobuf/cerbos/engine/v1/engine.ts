...
export function trace_Component_KindFromJSON(object: any): Trace_Component_Kind {
  switch (object) {
    case 0:
    case "KIND_UNSPECIFIED":
...
export function trace_Component_KindToJSON(object: Trace_Component_Kind): string {
  switch (object) {
...
export const PlanResourcesAst = {
  ...
  toJSON(message: PlanResourcesAst): unknown {
    ...
    message.filterAst !== undefined &&
      (obj.filterAst = message.filterAst ? PlanResourcesAst_Node.toJSON(message.filterAst) : undefined);
    return obj;
  },
};
...
export const PlanResourcesAst_Node = {
    ...
    return {
      node: isSet(object.logicalOperation)
        ? {
          ...
          logicalOperation: PlanResourcesAst_LogicalOperation.fromJSON(object.logicalOperation),
        }
        : isSet(object.expression)
        ? { $case: "expression", expression: CheckedExpr.fromJSON(object.expression) }
        : undefined,
    };
  },
  ...
  toJSON(message: PlanResourcesAst_Node): unknown {
    const obj: any = {};
    message.node?.$case === "logicalOperation" && (obj.logicalOperation = message.node?.logicalOperation
      ? PlanResourcesAst_LogicalOperation.toJSON(message.node?.logicalOperation)
      : undefined);
    message.node?.$case === "expression" &&
      (obj.expression = message.node?.expression ? CheckedExpr.toJSON(message.node?.expression) : undefined);
    return obj;
  },
};
...
export const PlanResourcesAst_LogicalOperation = {
  fromJSON(object: any): PlanResourcesAst_LogicalOperation {
    return {
      operator: isSet(object.operator) ? planResourcesAst_LogicalOperation_OperatorFromJSON(object.operator) : 0,
      nodes: Array.isArray(object?.nodes) ? object.nodes.map((e: any) => PlanResourcesAst_Node.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: PlanResourcesAst_LogicalOperation): unknown {
    ...
    message.operator !== undefined &&
      (obj.operator = planResourcesAst_LogicalOperation_OperatorToJSON(message.operator));
    if (message.nodes) {
      obj.nodes = message.nodes.map((e) => e ? PlanResourcesAst_Node.toJSON(e) : undefined);
    } else {
      obj.nodes = [];
    }
    return obj;
...
export const Trace = {
  fromJSON(object: any): Trace {
    return {
      components: Array.isArray(object?.components)
        ...
        : [],
      event: isSet(object.event) ? Trace_Event.fromJSON(object.event) : undefined,
    };
  },
  ...
  toJSON(message: Trace): unknown {
    ...
    if (message.components) {
      obj.components = message.components.map((e) => e ? Trace_Component.toJSON(e) : undefined);
    } else {
      obj.components = [];
    }
    message.event !== undefined && (obj.event = message.event ? Trace_Event.toJSON(message.event) : undefined);
    return obj;
  },
};
...
export const Trace_Component = {
  fromJSON(object: any): Trace_Component {
    return {
      ...
      details: isSet(object.action)
        ...
        : isSet(object.variable)
        ? { $case: "variable", variable: Trace_Component_Variable.fromJSON(object.variable) }
        : undefined,
    };
  },
  ...
  toJSON(message: Trace_Component): unknown {
    const obj: any = {};
    message.kind !== undefined && (obj.kind = trace_Component_KindToJSON(message.kind));
    message.details?.$case === "action" && (obj.action = message.details?.action);
    message.details?.$case === "derivedRole" && (obj.derivedRole = message.details?.derivedRole);
    message.details?.$case === "expr" && (obj.expr = message.details?.expr);
    message.details?.$case === "index" && (obj.index = Math.round(message.details?.index));
    message.details?.$case === "policy" && (obj.policy = message.details?.policy);
    message.details?.$case === "resource" && (obj.resource = message.details?.resource);
...
export const Trace_Event = {
  fromJSON(object: any): Trace_Event {
    return {
      status: isSet(object.status) ? trace_Event_StatusFromJSON(object.status) : 0,
      effect: isSet(object.effect) ? effectFromJSON(object.effect) : 0,
  ...
  toJSON(message: Trace_Event): unknown {
    const obj: any = {};
    message.status !== undefined && (obj.status = trace_Event_StatusToJSON(message.status));
    message.effect !== undefined && (obj.effect = effectToJSON(message.effect));
