...
export const Constant = {
  ...
  toJSON(message: Constant): unknown {
    ...
    message.constantKind?.$case === "int64Value" && (obj.int64Value = Math.round(message.constantKind?.int64Value));
    message.constantKind?.$case === "uint64Value" && (obj.uint64Value = Math.round(message.constantKind?.uint64Value));
