 ...
 */
export const file_cerbos_cloud_store_v1_store: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_google_api_visibility, file_google_protobuf_struct, file_google_protobuf_timestamp]);
 ...
 */
export const StringMatchSchema: GenMessage<StringMatch, {validType: StringMatchValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 0);

/**
 * @generated from message cerbos.cloud.store.v1.StringMatch.InList
 */
export type StringMatch_InList = Message<"cerbos.cloud.store.v1.StringMatch.InList"> & {
  /**
 ...
 */
export const StringMatch_InListSchema: GenMessage<StringMatch_InList, {validType: StringMatch_InListValid}> = /*@__PURE__*/
 ...
 */
export const FileFilterSchema: GenMessage<FileFilter, {validType: FileFilterValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 1);

/**
 * @generated from message cerbos.cloud.store.v1.ListFilesRequest
 */
export type ListFilesRequest = Message<"cerbos.cloud.store.v1.ListFilesRequest"> & {
  /**
 ...
 */
export const ListFilesRequestSchema: GenMessage<ListFilesRequest, {validType: ListFilesRequestValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 2);

/**
 * @generated from message cerbos.cloud.store.v1.ListFilesResponse
 */
export type ListFilesResponse = Message<"cerbos.cloud.store.v1.ListFilesResponse"> & {
  /**
 ...
 */
export const ListFilesResponseSchema: GenMessage<ListFilesResponse, {validType: ListFilesResponseValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 3);

/**
 * @generated from message cerbos.cloud.store.v1.GetFilesRequest
 */
export type GetFilesRequest = Message<"cerbos.cloud.store.v1.GetFilesRequest"> & {
  /**
   * @generated from field: string store_id = 1;
   */
  storeId: string;
 ...
 */
export const GetFilesRequestSchema: GenMessage<GetFilesRequest, {validType: GetFilesRequestValid}> = /*@__PURE__*/
 ...
 */
export type GetFilesResponse = Message<"cerbos.cloud.store.v1.GetFilesResponse"> & {
  /**
   * @generated from field: int64 store_version = 1;
   */
  storeVersion: bigint;
 ...
 */
export const GetFilesResponseSchema: GenMessage<GetFilesResponse, {validType: GetFilesResponseValid}> = /*@__PURE__*/
 ...
 */
export const ChangeDetailsSchema: GenMessage<ChangeDetails, {validType: ChangeDetailsValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 7);

/**
 * @generated from message cerbos.cloud.store.v1.ChangeDetails.Git
 */
export type ChangeDetails_Git = Message<"cerbos.cloud.store.v1.ChangeDetails.Git"> & {
  /**
 ...
 */
export const ChangeDetails_GitSchema: GenMessage<ChangeDetails_Git, {validType: ChangeDetails_GitValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 7, 0);

/**
 * @generated from message cerbos.cloud.store.v1.ChangeDetails.Internal
 */
export type ChangeDetails_Internal = Message<"cerbos.cloud.store.v1.ChangeDetails.Internal"> & {
  /**
 ...
 */
export const ChangeDetails_InternalSchema: GenMessage<ChangeDetails_Internal, {validType: ChangeDetails_InternalValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 7, 1);

/**
 * @generated from message cerbos.cloud.store.v1.ChangeDetails.Uploader
 */
export type ChangeDetails_Uploader = Message<"cerbos.cloud.store.v1.ChangeDetails.Uploader"> & {
  /**
 ...
 */
export const ChangeDetails_UploaderSchema: GenMessage<ChangeDetails_Uploader, {validType: ChangeDetails_UploaderValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 7, 2);
 ...
 */
export const FileOpSchema: GenMessage<FileOp, {validType: FileOpValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 8);

/**
 * @generated from message cerbos.cloud.store.v1.ModifyFilesRequest
 */
export type ModifyFilesRequest = Message<"cerbos.cloud.store.v1.ModifyFilesRequest"> & {
  /**
   * @generated from field: string store_id = 1;
   */
  storeId: string;
 ...
 */
export const ModifyFilesRequestSchema: GenMessage<ModifyFilesRequest, {validType: ModifyFilesRequestValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 9);

/**
 * @generated from message cerbos.cloud.store.v1.ModifyFilesRequest.Condition
 */
export type ModifyFilesRequest_Condition = Message<"cerbos.cloud.store.v1.ModifyFilesRequest.Condition"> & {
  /**
 ...
 */
export const ModifyFilesRequest_ConditionSchema: GenMessage<ModifyFilesRequest_Condition, {validType: ModifyFilesRequest_ConditionValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 9, 0);

/**
 * @generated from message cerbos.cloud.store.v1.ModifyFilesResponse
 */
export type ModifyFilesResponse = Message<"cerbos.cloud.store.v1.ModifyFilesResponse"> & {
  /**
 ...
 */
export const ModifyFilesResponseSchema: GenMessage<ModifyFilesResponse, {validType: ModifyFilesResponseValid}> = /*@__PURE__*/
  messageDesc(file_cerbos_cloud_store_v1_store, 10);

/**
 * @generated from message cerbos.cloud.store.v1.ReplaceFilesRequest
 */
export type ReplaceFilesRequest = Message<"cerbos.cloud.store.v1.ReplaceFilesRequest"> & {
  /**
   * @generated from field: string store_id = 1;
   */
  storeId: string;
 ...
 */
export const ReplaceFilesRequestSchema: GenMessage<ReplaceFilesRequest, {validType: ReplaceFilesRequestValid}> = /*@__PURE__*/
 ...
 */
export type ReplaceFilesRequest_Condition = Message<"cerbos.cloud.store.v1.ReplaceFilesRequest.Condition"> & {
  /**
   * @generated from field: int64 store_version_must_equal = 1;
   */
  storeVersionMustEqual: bigint;
 ...
 */
export const ReplaceFilesRequest_ConditionSchema: GenMessage<ReplaceFilesRequest_Condition, {validType: ReplaceFilesRequest_ConditionValid}> = /*@__PURE__*/
 ...
 */
export const ReplaceFilesResponseSchema: GenMessage<ReplaceFilesResponse, {validType: ReplaceFilesResponseValid}> = /*@__PURE__*/
...
export const CerbosStoreService: GenService<{
  ...
  serviceDesc(file_cerbos_cloud_store_v1_store, 0);
