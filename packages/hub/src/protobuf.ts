...
import type { GenMessage as GenMessageV1 } from "@bufbuild/protobuf/codegenv1";
import type { GenMessage as GenMessageV2 } from "@bufbuild/protobuf/codegenv2";
...
export type MessageInitShape<Desc extends DescMessage> =
  Desc extends GenMessageV1<infer RuntimeShape>
    ? MessageInit<RuntimeShape>
    : Desc extends GenMessageV2<infer RuntimeShape>
      ? MessageInit<RuntimeShape>
      : never;
