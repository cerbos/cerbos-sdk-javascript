...
- Bump dependency on [yaml] to 2.8.3 ([#1402](https://github.com/cerbos/cerbos-sdk-javascript/pull/1402))
...
- Bump dependency on [yaml] to 2.8.2 ([#1306](https://github.com/cerbos/cerbos-sdk-javascript/pull/1306))
...
- [`serializePolicy`](https://cerbos.github.io/cerbos-sdk-javascript/functions/_cerbos_files.serializePolicy.html) and [`writePolicy`](https://cerbos.github.io/cerbos-sdk-javascript/functions/_cerbos_files.writePolicy.html) functions to serialize policies to JSON-encoded strings and files ([#1174](https://github.com/cerbos/cerbos-sdk-javascript/pull/1174))
...
[unreleased]: https://github.com/cerbos/cerbos-sdk-javascript/compare/@cerbos/files@0.7.2...HEAD
[0.7.2]: https://github.com/cerbos/cerbos-sdk-javascript/compare/@cerbos/files@0.7.1...@cerbos/files@0.7.2
...
[0.4.4]: https://github.com/cerbos/cerbos-sdk-javascript/compare/@cerbos/files@0.4.3...@cerbos/files@0.4.4
