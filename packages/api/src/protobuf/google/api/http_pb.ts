...
export const file_google_api_http: GenFile =
  /*@__PURE__*/
  fileDesc(
    "",
  );
...
export type HttpRuleValid = HttpRule;

/**
 * Describes the message google.api.HttpRule.
 * Use `create(HttpRuleSchema)` to create a new message.
 */
export const HttpRuleSchema: GenMessage<
  HttpRule,
  { jsonType: HttpRuleJson; validType: HttpRuleValid }
> = /*@__PURE__*/ messageDesc(file_google_api_http, 0);
...
export type CustomHttpPatternValid = CustomHttpPattern;

/**
 * Describes the message google.api.CustomHttpPattern.
 * Use `create(CustomHttpPatternSchema)` to create a new message.
 */
export const CustomHttpPatternSchema: GenMessage<
  CustomHttpPattern,
  { jsonType: CustomHttpPatternJson; validType: CustomHttpPatternValid }
> = /*@__PURE__*/ messageDesc(file_google_api_http, 1);
