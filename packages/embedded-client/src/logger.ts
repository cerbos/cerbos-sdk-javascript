...
import {
  _auditTrailFromProtobuf,
  _checkInputFromProtobuf,
  _checkOutputFromProtobuf,
  _planResourcesInputFromProtobuf,
  _planResourcesOutputFromProtobuf,
  _requireField,
} from "@cerbos/core";
...
export class DecisionLogger {
  ...
  private async logDecision(
    ...
    await this.log({
      ...
      oversized: false,
      auditTrail: _auditTrailFromProtobuf(auditTrail),
      peer: {
        address: "",
        authInfo: "",
        forwardedFor: "",
...
function checkOutputs(
  ...
  return response.results.map<CheckOutput>((result) => {
    ...
    return _checkOutputFromProtobuf({
...
function planResourcesOutput(
  ...
  return _planResourcesOutputFromProtobuf({
