...
- Bump dependency on [@grpc/grpc-js] to 1.14.4 ([#1457](https://github.com/cerbos/cerbos-sdk-javascript/pull/1457))
...
- Bump dependency on [@grpc/grpc-js] to 1.14.3 ([#1314](https://github.com/cerbos/cerbos-sdk-javascript/pull/1314))
...
- Bump dependency on [@grpc/grpc-js] to 1.14.2 ([#1303](https://github.com/cerbos/cerbos-sdk-javascript/pull/1303))
...
- Bump dependency on [@grpc/grpc-js] to 1.14.1 ([#1282](https://github.com/cerbos/cerbos-sdk-javascript/pull/1282))
...
- Bump dependency on [@grpc/grpc-js] to 1.14.0 ([#1237](https://github.com/cerbos/cerbos-sdk-javascript/pull/1237))
...
- Bump dependency on [@bufbuild/protobuf] to 2.6.0 ([#1175](https://github.com/cerbos/cerbos-sdk-javascript/pull/1175), [#1191](https://github.com/cerbos/cerbos-sdk-javascript/pull/1191))
...
- [`ChannelOptions."grpc-node.flow_control_window"`](https://cerbos.github.io/cerbos-sdk-javascript/interfaces/_cerbos_grpc.ChannelOptions.html#grpc-nodeflow_control_window) option to set initial window size for HTTP/2 stream-level flow control ([#1122](https://github.com/cerbos/cerbos-sdk-javascript/pull/1122))
...
- [`Options.compression`](https://cerbos.github.io/cerbos-sdk-javascript/interfaces/_cerbos_grpc.Options.html#compression) to compress messages exchanged between the client and policy decision point server ([#1120](https://github.com/cerbos/cerbos-sdk-javascript/pull/1120))

  Requires a policy decision point server running Cerbos 0.19+.

- [`Options.channelOptions`](https://cerbos.github.io/cerbos-sdk-javascript/interfaces/_cerbos_grpc.Options.html#channeloptions) to configure advanced settings on the underlying gRPC client ([#1120](https://github.com/cerbos/cerbos-sdk-javascript/pull/1120))
...
[unreleased]: https://github.com/cerbos/cerbos-sdk-javascript/compare/@cerbos/grpc@0.29.1...HEAD
[0.29.1]: https://github.com/cerbos/cerbos-sdk-javascript/compare/@cerbos/grpc@0.29.0...@cerbos/grpc@0.29.1
...
[0.23.5]: https://github.com/cerbos/cerbos-sdk-javascript/compare/@cerbos/grpc@0.23.4...@cerbos/grpc@0.23.5
[0.23.4]: https://github.com/cerbos/cerbos-sdk-javascript/compare/@cerbos/grpc@0.23.3...@cerbos/grpc@0.23.4
