...
export type CerbosPlaygroundServiceService =
  typeof CerbosPlaygroundServiceService;
export const CerbosPlaygroundServiceService = {
  playgroundValidate: {
    ...
    requestDeserialize: (value: Buffer) =>
      PlaygroundValidateRequest.decode(value),
    responseSerialize: (value: PlaygroundValidateResponse) =>
      Buffer.from(PlaygroundValidateResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      PlaygroundValidateResponse.decode(value),
  },
  playgroundTest: {
    path: "/cerbos.svc.v1.CerbosPlaygroundService/PlaygroundTest",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: PlaygroundTestRequest) =>
      Buffer.from(PlaygroundTestRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => PlaygroundTestRequest.decode(value),
    responseSerialize: (value: PlaygroundTestResponse) =>
      Buffer.from(PlaygroundTestResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      PlaygroundTestResponse.decode(value),
  },
  playgroundEvaluate: {
    ...
    requestDeserialize: (value: Buffer) =>
      PlaygroundEvaluateRequest.decode(value),
    responseSerialize: (value: PlaygroundEvaluateResponse) =>
      Buffer.from(PlaygroundEvaluateResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      PlaygroundEvaluateResponse.decode(value),
  },
  playgroundProxy: {
    path: "/cerbos.svc.v1.CerbosPlaygroundService/PlaygroundProxy",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: PlaygroundProxyRequest) =>
      Buffer.from(PlaygroundProxyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => PlaygroundProxyRequest.decode(value),
    responseSerialize: (value: PlaygroundProxyResponse) =>
      Buffer.from(PlaygroundProxyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      PlaygroundProxyResponse.decode(value),
  },
} as const;

export interface CerbosPlaygroundServiceServer
  extends UntypedServiceImplementation {
  playgroundValidate: handleUnaryCall<
    PlaygroundValidateRequest,
    PlaygroundValidateResponse
  >;
  playgroundTest: handleUnaryCall<
    PlaygroundTestRequest,
    PlaygroundTestResponse
  >;
  playgroundEvaluate: handleUnaryCall<
    PlaygroundEvaluateRequest,
    PlaygroundEvaluateResponse
  >;
  playgroundProxy: handleUnaryCall<
    PlaygroundProxyRequest,
    PlaygroundProxyResponse
  >;
}
...
export interface CerbosPlaygroundServiceClient extends Client {
  playgroundValidate(
    ...
    callback: (
      error: ServiceError | null,
      response: PlaygroundValidateResponse
    ) => void
  ): ClientUnaryCall;
  playgroundValidate(
    request: PlaygroundValidateRequest,
  ...
  playgroundTest(
    ...
    callback: (
      error: ServiceError | null,
      response: PlaygroundTestResponse
    ) => void
  ): ClientUnaryCall;
  playgroundTest(
    request: PlaygroundTestRequest,
  ...
  playgroundProxy(
    ...
    callback: (
      error: ServiceError | null,
      response: PlaygroundProxyResponse
    ) => void
  ): ClientUnaryCall;
  playgroundProxy(
    request: PlaygroundProxyRequest,
