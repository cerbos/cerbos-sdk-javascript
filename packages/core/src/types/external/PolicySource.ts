...
/**
 * Policies sourced from an {@link https://docs.cerbos.dev/cerbos-hub/decision-points-embedded | embedded policy decision point}.
 *
 * @public
 */
...
/**
 * Policies sourced from a {@link https://docs.cerbos.dev/cerbos-hub/deployment-labels | label} in {@link https://www.cerbos.dev/product-cerbos-hub | Cerbos Hub} using the {@link https://docs.cerbos.dev/cerbos/latest/configuration/storage.html#hub | `hub` storage driver}.
 *
 * @public
 */
export interface PolicySourceHubLabel extends PolicySourceHubBase {
  /**
   * The {@link https://docs.cerbos.dev/cerbos-hub/deployment-labels | label} from which the policy bundle was downloaded.
   */
  label: string;
}
