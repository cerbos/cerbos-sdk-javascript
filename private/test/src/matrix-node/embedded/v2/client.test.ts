...
import type { DecodedJWTPayload, Options } from "@cerbos/embedded-client";
...
describe("Client", () => {
  ...
  const bundleId = "PS2MX9855QURB3Y8";
  const storeId = "NKFD70XLV8I5";

  function factory(options?: Partial<Options>): Client {
    return new Embedded({
      ...options,
      policies: readFile(
        resolve(__dirname, `../../../../bundles/${bundleId}.crrt`),
      ),
