        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.headers.push(
              HeaderParameter.decode(reader, reader.uint32()),
            );
            continue;
          }
        }
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3: {
            ...
            const entry3 = Response_HeadersEntry.decode(
              reader,
              reader.uint32(),
            );
          ...
          case 4: {
            ...
            const entry4 = Response_ExamplesEntry.decode(
              reader,
              reader.uint32(),
            );
...
export const SecurityRequirement_SecurityRequirementValue: MessageFns<SecurityRequirement_SecurityRequirementValue> =
  {
    ...
    decode(
      ...
      try {
        const end = length === undefined ? reader.len : reader.pos + length;
        const message =
          createBaseSecurityRequirement_SecurityRequirementValue();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
...
export const SecurityRequirement_SecurityRequirementEntry: MessageFns<SecurityRequirement_SecurityRequirementEntry> =
  {
    ...
    decode(
      ...
      try {
        const end = length === undefined ? reader.len : reader.pos + length;
        const message =
          createBaseSecurityRequirement_SecurityRequirementEntry();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
            ...
            case 2: {
              ...
              message.value =
                SecurityRequirement_SecurityRequirementValue.decode(
                  reader,
                  reader.uint32(),
                );
              continue;
